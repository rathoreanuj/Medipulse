  ...
  return (
    <div className='w-full max-w-7xl p-6'>
      ...
      <div className='bg-white border border-gray-200 rounded-lg shadow-sm overflow-hidden'>
        ...
        {/* Table Header */}
        <div className='hidden sm:grid sm:grid-cols-[0.5fr_2.5fr_1fr_2.5fr_2.5fr_1fr_1.5fr] bg-gray-50 border-b border-gray-200 py-3 px-6'>
          ...
          <p className='text-xs font-semibold text-gray-600 uppercase'>Doctor</p>
        ...
        <div className='divide-y divide-gray-200 max-h-[calc(100vh-250px)] overflow-y-auto'>
          {appointments.length === 0 ? (
            ...
            appointments.map((item, index) => (
              <div 
                className='grid grid-cols-1 sm:grid-cols-[0.5fr_2.5fr_1fr_2.5fr_2.5fr_1fr_1.5fr] items-center py-4 px-6 hover:bg-gray-50 transition-colors' 
                key={index}
              >
                {/* Index */}
                ...
                <div className='flex items-center gap-3'>
                  <img 
                    ...
                    className='w-10 h-10 rounded-full object-cover bg-blue-50 border border-gray-200' 
