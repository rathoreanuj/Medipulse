                                ...
                                <div className='flex sm:flex-col gap-2 justify-end items-end sm:items-stretch'>
                                    ...
                                    {!item.cancelled && (
                                        <button
                                            ...
                                            className='flex items-center gap-1.5 px-4 py-2 bg-blue-50 border border-primary text-primary rounded-lg hover:bg-primary hover:text-white transition-all duration-300 text-sm font-medium whitespace-nowrap'
                                        >
                                            <svg className='w-4 h-4' fill='none' stroke='currentColor' viewBox='0 0 24 24'>
